...
class Home extends Component {
  ...
  render() {
    ...
    return <div className="home">
            ...
            ></img>
            <div className="float-right invite-box1 pt-5" style={{
                ...
                {usersById[currentUserName].listBoard.map((card) => (
                    <div className="col-2" key={card}>
                        <div className="card text-center">
                            ...
                            <div className="card-body text-dark" style={{padding: "1rem 5px"}}>
                                <h4 className="card-title">{boardsById[card].boardTitle}</h4>
...
const mapStateToProps = state => ({ boardsById: state.boardsById, usersById: state.usersById });
